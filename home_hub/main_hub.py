            ...
            if message.lower() == "activated":
                ...
                try:
                    ...
                    for unit in bot_db.get_all_units():
                        all_ids.append(unit[0])
                    if unit_id not in all_ids:
                        shall_add = True
                            
                    if shall_add:
                        atlas_db.add_camera(unit_id, cleaned_message[0], unit_address[0], cleaned_message[3], message)
